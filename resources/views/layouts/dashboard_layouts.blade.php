...
<body class="font-poppins ">
    ...
    <nav
      id="view"
      class="h-screen w-auto z-10 overflow-y-scroll drop-shadow-lg flex flex-row"
      x-data="{ sidenav: true }"
    >
      <button
        @click="sidenav = true"
      ...
      >
        <div class="space-y-6 md:space-y-10 mt-10">
          ...
          <h1 class="hidden md:block font-bold text-sm md:text-xl text-center">
            Dashboard Study-Rq<span class="text-blue-600">.</span>
          </h1>
          <div id="profile" class="space-y-3">
            ...
            <div>
              ...
              <p class="text-xs text-gray-500 text-center">Guru</p>
            </div>
          </div>
          {{-- <div
            class="flex border-2 border-gray-200 rounded-md focus-within:ring-2 ring-blue-500"
          >
            <input
              type="text"
