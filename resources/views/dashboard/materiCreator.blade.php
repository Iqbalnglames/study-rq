    ...
    <form method="POST" action="{{ route('/buat-materi') }}">
        ...
        <div class="space-y-3">
            <div class="flex flex-col">
                ...
                <input type="text"
                    class="p-2 rounded-sm w-96 border overflow-x-hidden border-slate-300 focus:ring-blue-500" name="title"
                    value="{{ old('title') }}" placeholder="Tulis judul materi di sini">
            </div>
            ...
            <button type="submit" class="p-2 rounded-md bg-green-500 border border-slate-300 text-white">Posting
                Materi</button>
